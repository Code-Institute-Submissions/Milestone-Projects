...
This application represents a service provider Issue Tracker Prime which is user focused and allows User A to actively
...
* Issue Tracking Page - This is the main area of the project where users can see current tickets including their name, description, upvotes, comments and date created. In addition features have the total pledged and payment option to support the feature available to authenticated users. Users can also filter the tickets shown based on given criteria including topic (BUG or FEATURE), name, upvotes and status (TO DO, DOING, DONE)
...
* Register Page - A form allows users to register their username, email and password (which must be confirmed) in order to login and access authenticated functionality such as posting a comment and/or make payment in support of features
...
* 1 - **Creating a Ticket**
    1. Users can create new tickets using a form
* 2 - **Filtering Tickets Shown**
    2. Users can filter what tickets are shown based on criteria including name, upvotes and status
* 3 - **Adding Comments to Tickets**
    3. Users who are logged in can add comments to a ticket
* 4 - **Making Payment to Support Features**
    4. Users who are logged in can make payments through Stripe to support a feature
* 5 - **Register**
    5. Users can register a username, email and password in order to log in an access additional features
* 6 - **Login**
    6. Users can login using a form
* 7 - **Logout**
    7. Authenticated users can logout
* 8 - **Reset Password**
    8. Users who have forgot their password can request a reset using a form and following the instructions and email link to create a new password
...
- **[Font Awesome](https://fontawesome.com/)** - A larget icon toolkit and library of font icons used in this project
